...
asio::awaitable<silkworm::Bytes> TransactionDatabase::get(const std::string& table_name, const silkworm::Bytes& key) {
    const auto kv_pair = co_await tx_.cursor()->seek(table_name, key);
