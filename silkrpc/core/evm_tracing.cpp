...
void DebugTracer::on_instruction_start(uint32_t pc, const evmone::advanced::AdvancedExecutionState& execution_state, const silkworm::IntraBlockState& intra_block_state) noexcept {
