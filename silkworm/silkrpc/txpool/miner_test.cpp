...
TEST_CASE_METHOD(MinerTest, "Miner::get_hashrate", "[silkrpc][txpool][miner]") {
...
TEST_CASE_METHOD(MinerTest, "Miner::get_mining", "[silkrpc][txpool][miner]") {
...
TEST_CASE_METHOD(MinerTest, "Miner::submit_work", "[silkrpc][txpool][miner]") {
...
TEST_CASE_METHOD(MinerTest, "Miner::submit_hash_rate", "[silkrpc][txpool][miner]") {
