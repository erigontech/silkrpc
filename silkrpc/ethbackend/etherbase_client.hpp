...
public:
    ...
    void async_call(std::function<void(const ::grpc::Status&, const ::remote::EtherbaseReply&)> completed) {
        SILKRPC_TRACE << "EtherbaseClient::async_call " << this << " state: " << magic_enum::enum_name(state_) << " start\n";
        ...
        SILKRPC_TRACE << "EtherbaseClient::async_call " << this << " state: " << magic_enum::enum_name(state_) << " end\n";
    }
