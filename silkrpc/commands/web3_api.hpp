...
#ifndef SILKRPC_COMMANDS_WEB3_API_HPP_
...
protected:
    asio::awaitable<void> handle_web3_client_version(const nlohmann::json& request, nlohmann::json& reply);
...
#endif  // SILKRPC_COMMANDS_WEB3_API_HPP_
