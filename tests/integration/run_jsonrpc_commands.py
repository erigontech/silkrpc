...
run_shell_command('''curl --silent -X POST -H "Content-Type: application/json" --data '{"jsonrpc":"2.0","method":"eth_getUncleByBlockHashAndIndex","params":["0x814672e6913a3879217169c6ba461114fa032d9510a56a409d3aab19f668e299",0],"id":1}' localhost:51515''')
