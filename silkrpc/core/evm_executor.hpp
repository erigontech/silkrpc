...
public:
    ...
    asio::awaitable<ExecutionResult> call(const silkworm::Block& block, const silkworm::Transaction& txn, bool refund = true, std::shared_ptr<silkworm::EvmTracer> tracer = {});
