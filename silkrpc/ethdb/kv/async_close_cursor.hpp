...
#ifndef SILKRPC_ETHDB_KV_ASYNC_CLOSE_CURSOR_HPP_
#define SILKRPC_ETHDB_KV_ASYNC_CLOSE_CURSOR_HPP_
...
class async_close_cursor : public async_operation<void, asio::error_code, uint32_t> {
public:
...
#endif // SILKRPC_ETHDB_KV_ASYNC_CLOSE_CURSOR_HPP_
